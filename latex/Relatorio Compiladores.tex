...
\autor{Gustavo Pacianotto Gouveia (NUSP 6482819), Victor Lassance (NUSP 6431325)}
...
\chapter{Questões}
\label{chap:questoes}
	\input{chapters/2-questoes/*-questoes}

\chapter{Conclusão}
\label{chap:conclusao}
	\input{chapters/3-conclusao}
...
\label{app:codigo}
\lstinputlisting[frame=single,language=C,numbers=left]{../lex/lex.c}

\chapter{Código em C do método principal do Analisador Léxico}
\label{app:codigo}
\lstinputlisting[frame=single,language=C,numbers=left]{../lex/test.c}
